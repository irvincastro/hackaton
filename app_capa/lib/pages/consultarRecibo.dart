...
class ConsultarRecibo extends StatefulWidget {
  @override
  _ConsultarReciboState createState() => _ConsultarReciboState();
}

class _ConsultarReciboState extends State<ConsultarRecibo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "Consultar Recibo (Previsualizar)",
