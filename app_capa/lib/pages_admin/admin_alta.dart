...
class AdminAlta extends StatelessWidget {
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              SizedBox(height: 10),
              cuadro(context, "Padrón de usuarios"),
              SizedBox(height: 10),
              cuadro(context, "Alta empleado"),
              SizedBox(height: 10),
              cuadro(context, "Alta administrador"),
              SizedBox(height: 10),
              cuadro(context, "Crear encuesta"),
              SizedBox(height: 10),
            ],
          ),
        ),
